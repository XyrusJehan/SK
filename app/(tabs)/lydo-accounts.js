...
const M = StyleSheet.create({
  ...
  modal: { backgroundColor: COLORS.offWhite, borderRadius: 16, width: isMobile ? '96%' : 660, maxHeight: MODAL_MAX_HEIGHT, flexShrink: 1, shadowColor: '#000', shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.4, shadowRadius: 28, elevation: 28, overflow: 'hidden' },
